...
{
    public const string ScenePath = "Assets/_Project/Dev/Labs/F1/BossPracticeLab.unity";

    [MenuItem("Tools/Subject42/Dev/F1 Inspector/Open Boss Practice")]
    ...
    public static void Create()
    {
        ...
        try
        {
            ...
            var material = AssetDatabase.LoadAssetAtPath<Material>("Assets/_Project/Dev/Labs/F1/BossPracticeGrid.mat");
            if (material == null)
            {
                material = new Material(Shader.Find("Sprites/Default"));
                AssetDatabase.CreateAsset(material, "Assets/_Project/Dev/Labs/F1/BossPracticeGrid.mat");
            }
